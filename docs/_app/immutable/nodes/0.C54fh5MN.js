...
}`;var T=l('<link rel="icon"/> <link rel="stylesheet" href=""/>',1),D=l('<!> <nav id="main-nav"><a href="/">&gt; <span>Tapioca</span><span>Fox</span></a>  <a href="/projects">[Projects]</a> <a href="/artworks">[Artworks]</a> <a href="/patio">[Patio]</a></nav> <!>',1);function L(p,d){var o=D();w(u=>{var s=T();g.title="TapiocaFox";var h=a(s);x(2),z(()=>P(h,"href",j)),c(u,s)});var t=a(o);k(t,{mode:"background",show_code_block:!1,get fragment_shader(){return F}});var e=n(t,2),r=v(e),i=n(v(r));_(i,"",{},{"font-weight":"bold",color:"var(--fox-secondary-color)"});var f=n(i);_(f,"",{},{"font-weight":"bold",color:"var(--fox-primary-color)"}),m(r),x(6),m(e);var y=n(e,2);C(y,()=>d.children??b),c(p,o)}export{L as component,B as universal};
