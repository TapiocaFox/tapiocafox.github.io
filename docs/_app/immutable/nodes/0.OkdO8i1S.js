...
}`;var j=m('<link rel="icon"/>'),D=m('<!> <nav id="main-nav"><a href="/">&gt; <span>Tapioca</span><span>Fox</span></a>  <a href="/projects">[Projects]</a> <a href="/artworks">[Artworks]</a> <a href="/patio">[Patio]</a></nav> <!>',1);function M(_,p){var o=D();b(f=>{var s=j();u.title="TapiocaFox",h(()=>C(s,"href",k)),a(f,s)});var t=y(o);P(t,{mode:"background",show_code_block:!1,get vertex_shader(){return I},get fragment_shader(){return F}});var e=n(t,2),r=c(e),i=n(c(r));v(i,"",{},{"font-weight":"bold",color:"var(--fox-secondary-color)"});var d=n(i);v(d,"",{},{"font-weight":"bold",color:"var(--fox-primary-color)"}),x(r),g(6),x(e);var l=n(e,2);w(l,()=>p.children??z),a(_,o)}export{M as component,B as universal};
