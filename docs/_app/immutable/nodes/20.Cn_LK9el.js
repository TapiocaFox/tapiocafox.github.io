import"../chunks/DsnmJJEf.js";import{p as z,ax as k,f as x,e as u,a as r,b as C,s as v,x as I,o as e,y as P,aV as w,r as d,n as F,g as S,c as T}from"../chunks/L9KMEEf_.js";import{i as A}from"../chunks/BK9JfO0w.js";import{e as G,i as D}from"../chunks/DsfcHBVq.js";import{C as L}from"../chunks/uyAgYwlx.js";import{H as j}from"../chunks/aHyPWndq.js";import{G as E}from"../chunks/DU9Un2yO.js";import{d as q,e as B}from"../chunks/BDU8M7v3.js";import{a as M,b as N,s as O}from"../chunks/CjiA10hm.js";import{g as H}from"../chunks/Bh0sFhki.js";const Y=`// Author: TapiocaFox
// Title: Mouse
...
void main() {
    ...
    gl_FragColor = vec4(color,1.0);
}`;var J=x('<div class="item shader_item svelte-1xj01x5"><!></div>'),K=x('<!> <!> <h3>Practice One</h3> <p class="annotation">Abstract patterns animated over time. (Part of Assignment One.)</p> <div class="flex_grid gallery"></div>    <p class="annotation compact">Some of them are interactable with the mouse. I like to "vibe code" shaders with my <a href="https://music.apple.com/us/playlist/psychedelic/pl.u-r2yBAdYCAMeYoe" target="_blank">music playlist</a>.</p>',1);function ie(p,f){z(f,!0);let o=P("all"),g=k([{shader:q,categories:[]},{shader:M,categories:["distortion"]},{shader:Y,categories:[]},{shader:N,categories:[]},{shader:V,categories:["distortion"]},{shader:W,categories:[]},{shader:O,categories:["noise"]},{shader:$,categories:["noise"]}]);var a=K(),c=u(a);j(c,{text:"GLSL Shader"});var l=v(c,2);{let t=w(()=>[null,null,null,B]);L(l,{names:["All categories","Noise","Distortion","Editor"],get inline_icons(){return e(t)},values:["all","noise","distortion","editor"],get selected_value(){return e(o)},callback:n=>{n=="editor"?H("/glsl/editor"):I(o,n,!0)}})}var _=v(l,6);G(_,21,()=>g,D,(t,n)=>{var m=S(),h=u(m);{var y=s=>{var i=J(),b=T(i);E(b,{get fragment_shader(){return e(n).shader}}),d(i),r(s,i)};A(h,s=>{(e(o)=="all"||e(n).categories.includes(e(o)))&&s(y)})}r(t,m)}),d(_),F(2),r(p,a),C()}export{ie as component};
