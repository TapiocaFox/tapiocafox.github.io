import"../chunks/DsnmJJEf.js";import{av as I,f as h,e as x,t as C,a as c,s as o,h as P,i as n,j as F,c as f,n as p,r as _,g as T}from"../chunks/BU-BJxkg.js";import{i as S}from"../chunks/Cyw0M31N.js";import{e as G,i as A}from"../chunks/B1kzFQrc.js";import{s as L}from"../chunks/GMcADXPf.js";import{s as q}from"../chunks/BrTCo6EZ.js";import{C as j}from"../chunks/BTOMrOF7.js";import{H as D}from"../chunks/CnBIkCwv.js";import{d as E,e as B,G as M}from"../chunks/DvUkaoGb.js";import{a as N,b as Y}from"../chunks/BC6LL0MR.js";const H=`// Author: TapiocaFox
// Title: Mouse
...
void main() {
    ...
    gl_FragColor = vec4(color,1.0);
}`;var K=h('<div class="item shader_item svelte-ynuj4"><!></div>'),Q=h('<!> <!> <p class="annotation">These are my personal practice of GLSL. You can try it yourself in <img class="inline-glyph" alt="Edit"/><a href="/glsl/editor">the editor</a>.</p> <div class="flex_grid"></div>    <p class="annotation compact">Some of them are interactable with the mouse. I like to "vibe code" shaders with my <a href="https://music.apple.com/us/playlist/psychedelic/pl.u-r2yBAdYCAMeYoe" target="_blank">music playlist</a>.</p>',1);function rn(y){let e=F("all"),g=I([{shader:E,categories:[]},{shader:N,categories:["distortion"]},{shader:H,categories:[]},{shader:Y,categories:[]},{shader:O,categories:["distortion"]},{shader:W,categories:[]},{shader:R,categories:["noise"]},{shader:J,categories:["noise"]}]);var l=Q(),m=x(l);D(m,{text:"GLSL shader"});var u=o(m,2);j(u,{names:["All categories","Noise","Distortion"],values:["all","noise","distortion"],get selected_value(){return n(e)},callback:i=>{P(e,i,!0)}});var t=o(u,2),z=o(f(t));p(2),_(t);var s=o(t,2);q(s,"",{},{width:"100%",gap:"12px",margin:"1rem 0"}),G(s,21,()=>g,A,(i,d)=>{var v=T(),b=x(v);{var k=r=>{var a=K(),w=f(a);M(w,{get fragment_shader(){return n(d).shader}}),_(a),c(r,a)};S(b,r=>{(n(e)=="all"||n(d).categories.includes(n(e)))&&r(k)})}c(i,v)}),_(s),p(2),C(()=>L(z,"src",B)),c(y,l)}export{rn as component};
