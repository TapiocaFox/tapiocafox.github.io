import"../chunks/DsnmJJEf.js";import"../chunks/BT3W6beP.js";import{f as d,e as p,t as v,a as x,s as n,c as h,n as c,r as g}from"../chunks/Q6qDtJCQ.js";import{s as y}from"../chunks/-KVrhg4G.js";import{H as I}from"../chunks/WpVhzMs_.js";import{G as e,e as b}from"../chunks/K15hfvp_.js";import{a as P,b as k}from"../chunks/CKLAX-Q9.js";const F=`// Author: TapiocaFox
// Title: Radiant
...
void main() {
    ...
    gl_FragColor = vec4(color,1.0);
}`;var C=d('<!> <p class="annotation">These are my personal practice of GLSL. You can try it yourself in <img class="inline-glyph" alt="Edit"/><a href="/glsl/editor">the editor</a>.</p> <!>  <!> <!> <!> <!> <!> <p class="annotation compact">Some of them are interactable with the mouse. I like to "vibe code" shaders with my <a href="https://music.apple.com/us/playlist/psychedelic/pl.u-r2yBAdYCAMeYoe" target="_blank">music playlist</a>.</p>',1);function B(l){var o=C(),i=p(o);I(i,{text:"GLSL shader"});var t=n(i,2),u=n(h(t));c(2),g(t);var r=n(t,2);e(r,{});var s=n(r,2);e(s,{get fragment_shader(){return P}});var a=n(s,2);e(a,{get fragment_shader(){return F}});var _=n(a,2);e(_,{get fragment_shader(){return k}});var m=n(_,2);e(m,{get fragment_shader(){return q}});var f=n(m,2);e(f,{get fragment_shader(){return w}}),c(2),v(()=>y(u,"src",b)),x(l,o)}export{B as component};
