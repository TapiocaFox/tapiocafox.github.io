...
<div class="card">
    ...
    <p>It was used by my university's radio station "goto&Play". (A channel embedded as a chat bubble. The admins have fine-grained control through the interface as shown.)</p>
