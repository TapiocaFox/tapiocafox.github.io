...
<div class="card">
    ...
    <p>It was used by my university's radio station "goto&Play". As a live chatting bubble binded to a Talksy channel. Admins have fine-grained control through the interface as shown. User can login to access the interface, but only with the channels where the permissions are given.</p>
