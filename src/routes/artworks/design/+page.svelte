...
<p class="annotation compact">This was my personal website during undergrad. Managed a minecraft server for math majors, and later developed a content management system (CMS) mentioned in <a href="/projects">projects</a>. And I was fortunate to get a lots of feedbacks at the time to bring more improvements. And our dorms had Gigabit network since NCTU's infrastructure is part of Taiwanese internet backbone.</p>
{/if}
