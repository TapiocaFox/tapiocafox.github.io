<script lang="ts">
	...
	import skyline from '$lib/assets/sketchings/skyline.png';
	import indigenous from '$lib/assets/sketchings/indigenous.jpg';
	import garden_urn from '$lib/assets/sketchings/garden_urn.png';
	import trunk from '$lib/assets/sketchings/trunk.png';
	import osaka from '$lib/assets/sketchings/osaka.png';
	import ping_pong from '$lib/assets/sketchings/ping_pong.png';
...
<HeaderWithBackButton text="Sketchings"/>
<p class="bold-annotation">Mostly things in real life, or quirky ideas inside of my head.</p>
<img class="sketching" alt="Skyline" src={skyline}/>
<p class="annotation compact">A skyline view from Brooklyn promenade. It was very tedious to delineate every details of the buildings. So I only drew the parts that I think matters for the holism.</p>
<img class="sketching" alt="Indigenous" src={indigenous}/>
<p class="annotation compact">An imaginary person that appeared in my brain. It definitely follows a certain indigenous style, but I forgot where and what exactly I got inspired from.</p>
<img class="sketching_in_row" alt="Garden Urn" src={garden_urn}/><img class="sketching_in_row" alt="Trunk" src={trunk}/>
<p class="annotation compact">A garden urn in manhattan. It was a nice weather. The trunk is pretty barebone, but I like my line flow here.</p>
<img class="sketching" alt="Osaka" src={osaka}/>
<p class="annotation compact">An anime style girl from the "Azumanga" series. I like her nonchalant and goofy attitude.</p>
<img class="sketching" alt="Border Collie" src={border_collie}/>
<p class="annotation compact">I drew border collies, and plan to draw other species in canidae family. Because they share very similar features. I think the muzzles are the key here.</p>
